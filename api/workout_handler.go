...
func NewWorkoutHandler(workoutStore stores.WorkoutStore, logger *log.Logger) *WorkoutHandler {
...
func (wh *WorkoutHandler) HandleGetWorkoutByID(w http.ResponseWriter, r *http.Request) {
	...
	if currentUser == nil || currentUser == stores.AnonymousUser {
